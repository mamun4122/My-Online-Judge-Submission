...
void update(int node,int b,int e,int i,int j)
{
    ...
    if(tree[Left].sum!=mid-b+1)update(Left,b,mid,i,j);
    if(tree[Right].sum!=e-mid)update(Right,mid+1,e,i,j);
    tree[node]=call(tree[Left],tree[Right]);
}

///https://discuss.codechef.com/questions/56781/gss4-spoj-tle?page=1#59074
int main()
{
